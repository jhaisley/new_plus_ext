...
suite('Configuration Entity Tests', () => {
    ...
    test('Configuration should accept custom values', () => {
        const config = new configuration_1.Configuration('C:\\Custom\\Templates', false, true, true);
    ...
    test('Configuration should validate templates path is not empty', () => {
        assert.throws(() => {
            new configuration_1.Configuration('', true, false, false);
        });
    });
    test('Configuration should normalize paths', () => {
        const config = new configuration_1.Configuration('C:\\Templates\\\\SubFolder\\');
    ...
    test('Configuration should handle environment variables in path', () => {
        const config = new configuration_1.Configuration('%USERPROFILE%\\Templates');
